...
class AppSyncClient {
  ...
  async getCardIdsByBackAudioTaskId(task_id) {
    var query = gql(`
      query GetCardIdsByBackAudioTaskId($task_id: String!) {
        getCardIdsByBackAudioTaskId(back_audio_task_id: $task_id) {
          items {
            card_id
            back_audio_task_id
          }
    ...
    return response.data.getCardIdsByBackAudioTaskId.items; 
  }
